...
def operacion_sin_variable(expresion, pos):
    pilaOp = Pila()
    try:
        ...
        print "Res de la operacion "+str(pos)+" = " +str(operada)
    except:
...
if len(errores)==0:
    for expresion in listaExpresiones:
        ...
        if expresion[len(expresion)-1]!="=":
            operacion_sin_variable(expresion,posError)
        elif posError >0:
            if esVariable(expresion[len(expresion)-2]):
                    ...
                    if esVariable(elemento):
                        ...
                        if expresion[i+1]=="=":
                            ...
                            if(not pila.es_vacia()):
                                print "Escritura en postorden invalida en la linea: "+str (posError)
                                posError=-1
                                break
                            ...
                            for objeto in variables:
                                if(objeto.identificador==elemento):
                                    ...
                                    encontrado=True
                            if not encontrado:
                                print "Expresion mal formada en la linea: " + str(posError)
                                posError=-1
                                break
                ...
                print "No hay variable en la linea "+str(posError)
                posError=-1
                break
        else:
            break
